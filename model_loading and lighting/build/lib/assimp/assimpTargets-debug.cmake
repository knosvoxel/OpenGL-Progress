...
if(MSVC)
  ...
  if(ASSIMP_BUILD_SHARED_LIBS)
    ...
    set(staticLibraryName "assimp${ASSIMP_LIBRARY_SUFFIX}d.a")
  ...
  if(ASSIMP_BUILD_SHARED_LIBS)
    set(sharedLibraryName "libassimp${ASSIMP_LIBRARY_SUFFIX}d.so.5")
    set_target_properties(assimp::assimp PROPERTIES
    ...
    set(staticLibraryName "libassimp${ASSIMP_LIBRARY_SUFFIX}d.a")
    set_target_properties(assimp::assimp PROPERTIES
      IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/${staticLibraryName}"
    )
    list(APPEND _IMPORT_CHECK_TARGETS assimp::assimp )
